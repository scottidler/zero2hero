...
namespace z2h {
    ...
    template <typename TAst, typename TParser>
    using ScanPtr = TAst (TParser::*)(Symbol<TAst> *symbol, const std::string &source, size_t lbp);
...
*/
        NudFunc<TAst> BindNud(NudPtr<TAst, TParser> method) {
            return std::bind(method, this, _1);
        }
/*
        ...
        ScanFunc<TAst> BindScan(ScanPtr<TAst, TParser> method) {
            return std::bind(method, this, _1, _2, _3);
        }
*/
